                ...
                <div style={{ paddingTop: 10, display: 'flex', flexDirection: 'row' }}>
                    ...
                    {/* <Button onClick={() => {
                        ...
                        // }
                            ...
                            <EditOutlined /> {isEditing ? "Cancel" : "Edit" }
                    </Button> */}
                    <Button onClick={() => 
                        history.push("/manager/projects/manage/" + props.projectId + "/manageForm/" + props.objectRef)
                        // alert("Manage Forms is coming soon")
                    }
